...
"""
$time python analysisEvolutionFinal-Parellel.py  -n 200000  -th 0.01 -m 0.45 -T 0.6 -tm1 0.4 -tm2 0.6 -md 2 -ns 2 -nc 40 -change 0
"""
...
# Parallel(n_jobs = num_cores)(delayed(cascade_size)(i) for i in mean_degree_list)
