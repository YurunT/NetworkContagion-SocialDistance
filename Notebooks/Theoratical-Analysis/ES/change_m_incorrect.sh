...
'''
       ...
       time python MaskModelDerivation-vR-startfrom0-play.py            -n 2000000  -th 0.01 -m $p_mask -T 0.6 -tm1 0.3 -tm2 0.7 -md 10 -ns 50 -nc 40 -change 0
       
       time python analysisEvolutionFinal-Parellel-INcorrect-Rashad.py  -n 2000000  -th 0.01 -m $p_mask -T 0.6 -tm1 0.3 -tm2 0.7 -md 10 -ns 50 -nc 40 -change 0
