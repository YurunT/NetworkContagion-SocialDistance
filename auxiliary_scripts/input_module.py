...
def add_args(args, parser):
    ...
    parser.add_argument('-tm1', nargs='+', type = float, help='Specify a list of M INward effeciencies for M types of masks, from type 0 to M')
    parser.add_argument('-tm2', nargs='+', type = float, help='Specify a list of M OUTward effeciencies for M types of masks, from type 0 to M')
