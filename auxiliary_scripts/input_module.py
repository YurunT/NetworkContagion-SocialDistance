...
def add_args_analysis(parser):
    parser.add_argument('-modelname', type = str, default = 'mask', help='choose from {mask, mutation,}')
    parser.add_argument('-itemname' , type = str, default = 'es',   help='choose from {es, pe}'  )
    return parser
    

def parse_args(args):
    '''
    parse function for simulation
    '''
    parser = argparse.ArgumentParser(description = 'Parameters')
    parser = add_args_sim(args, parser)
    return parser.parse_args(args)

def parse_args_analysis(args):
    '''
    parse function for analysis
    '''
    parser = argparse.ArgumentParser(description = 'Parameters')
    parser = add_args_sim(args, parser)
    parser = add_args_analysis(parser)
    return parser.parse_args(args)
