...
t1 = Q_dict['Q1'] # Q1
t2 = Q_dict['Q2'] # Q2
m1 = mu_dict['mu11'] # mu11
m2 = mu_dict['mu22'] ## mu22
...
ExpPath = '../MutationResults/' + 'm' + str(mask_prob) + '/T' + "{0:.2f}".format(T) + '/tm1_' + "{0:.2f}".format(T_mask1) + '_tm2_' + "{0:.2f}".format(T_mask2) + '/' + timeExp + '_n' + str(num_nodes) + '_e' + str(numExp)
