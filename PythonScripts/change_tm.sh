...
#	python Mask-2-Tmask12_newpath-Ray.py -n 500000 -e 10000 -th 0.01 -m 0.45 -T 0.6 -tm1 $T_mask1 -tm2 $T_mask2 -md 10 -ns 50
	time python Mask-2-Tmask12_newpath-Ray-limitCore-100save.py -n 5000 -e 100 -th 0.01 -m 0.45 -T 0.6 -tm1 $T_mask1 -tm2 $T_mask2  -md 10 -ns 50 -nc 40 -cp 500 -change 2
done
