...
do
	echo $p_mask
    time python analysis.py -modelname mask -itemname pe -m $p_mask -T 0.6 -tm1 0.3 -tm2 0.7 -mind 0 -maxd 9 -ns 50 -nc 40 -change 0 -msg single_point -mdl 9.79591837
done

for p_mask in 0.45
do
	echo $p_mask
    time python analysis.py -modelname mask -itemname pe -m $p_mask -T 0.6 -tm1 0.3 -tm2 0.7 -mind 0 -maxd 9 -ns 50 -nc 40 -change 0 -msg single_point -mdl 10
done

for p_mask in 0.45
do
	echo $p_mask
    time python analysis.py -modelname mask -itemname pe -m $p_mask -T 0.6 -tm1 0.3 -tm2 0.7 -mind 0 -maxd 9 -ns 50 -nc 40 -change 0 -msg single_point -mdl 11
done

# for p_mask in 0.45
# do
# 	echo $p_mask
#     time python analysis.py -modelname mask -itemname es -m $p_mask -T 0.6 -tm1 0.3 -tm2 0.7 -mind 0 -maxd 10 -ns 50 -nc 40 -change 0 -msg single_point #-mdl 3.06122449
# done

# for p_mask in 0.45
# do
# 	echo $p_mask
#     time python analysis.py -modelname mask -itemname es -m $p_mask -T 0.6 -tm1 0.3 -tm2 0.7 -mind 0 -maxd 11 -ns 50 -nc 40 -change 0 -msg single_point #-mdl 3.06122449
# done