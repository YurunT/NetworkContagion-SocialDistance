...
print('Running Mask_ES_Analysis.py ...')
...
def parse_args(args):
    ...
    parser.add_argument('-m',   type = float, default = 0.45, help='0.45 (default); the prob of wearing a mask')
    parser.add_argument('-tm1', type = float, default = 0.3, help='0.3 (default); T_mask1')
    parser.add_argument('-tm2', type = float, default = 0.7, help='0.7 (default); T_mask2')
