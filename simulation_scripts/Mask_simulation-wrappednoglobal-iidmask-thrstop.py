...
def main():
    ...
    mean_degree_list = [1.02040816 1.2244898  1.42857143 1.63265306 1.83673469]
    ...
    ExpPath = 'Mask_Simulation_'+ change_folder +'/' + 'm' + str(mask_prob) + '_T' + "{0:.2f}".format(T) + '_tm1_' + "{0:.2f}".format(T_mask1) + '_tm2_' + "{0:.2f}".format(T_mask2) + '/' + timeExp
...
#     draw_figures(mean_degree_list, Prob_Emergence, AvgValidSize, AvgSize, ExpPath, mask_prob)
    ...
    for start_strain in [1, 2]:
        print("Start strain:", start_strain)
        reach_thr = False
